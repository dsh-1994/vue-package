<template>
  <DLayout
    ...
    v-model:menuSelected="menuSelected"
    v-on:update:menuOpened="onMenuOpened"
    v-on:update:menuSelected="onMenuSelected"
    :tabOptions="tabOptions"
    v-model:tabSelectValue="tabSelectValue"
    v-on:update:tabOptions="onTabOptions"
    v-on:update:tabSelectValue="onTabSelectValue"
    v-on:delete:tabOption="onDeleteTabOption"
  >
...
const menuOptions = computed<DLayoutMenuOptions>(() => [
  {
    ...
    children: [
      { title: t('menu.hotel'), value: 'workbenches-hotel' },
      {
        title: t('menu.secondaryConfirmation'),
        value: 'workbenches-secondary_confirmation',
      },
      { title: t('menu.planeTicket'), value: 'workbenches-plane_ticket' },
      { title: t('menu.operation'), value: 'workbenches-operation' },
    ],
  },
  {
